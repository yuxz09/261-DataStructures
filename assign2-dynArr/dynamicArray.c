...
//freeDynArr frees memory allocated for the underlying array v->data, 
//deleteDynArr frees memory allocated for the struct itself
//calling freeDynArr in the process of cleaning up
...
void removeDynArr(DynArr *v, TYPE val)
{
	...
	int removed = 0;
	////////////////////////////
	for (int i = 0; i < v->size && removed == 0; i++)
	{
		if (v -> data[i] == val)
		{
